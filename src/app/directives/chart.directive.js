...
angular
    .module('myproject')
    .directive('acmeAngularChart', angularChart);
function angularChart($compile, $q){
        ...
        link: function (scope, element, attrs) {
            scope.$watch('options', function(){
                ...
                scope.updateChart = function () {
                    ...
                    // Remove the max-height set by c3-chart.css Failed to load resource: the server responded with a status of 404 (Not Found).js
